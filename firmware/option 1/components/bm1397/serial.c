...
// UART for EKOminer
#define EKO_ECHO_TEST_TXD (12)
#define EKO_ECHO_TEST_RXD (13)

#define BUF_SIZE (1024)

static const char *TAG = "serial";
// extern GlobalState GLOBAL_STATE = {.extranonce_str = NULL, .extranonce_2_len = 0, .abandon_work = 0, .version_mask = 0};
...
void SERIAL_init(void)
{
    ...
    //         // Set UART1 pins(TX: IO12, RX: I013)
    //         uart_set_pin(UART_NUM_1, EKO_ECHO_TEST_TXD, EKO_ECHO_TEST_RXD, UART_PIN_NO_CHANGE, UART_PIN_NO_CHANGE);                    
    //         break;            
    //     default:
