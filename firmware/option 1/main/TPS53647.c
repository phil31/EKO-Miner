...
static esp_err_t smb_read_byte(uint8_t command, uint8_t *data)
{
    ...
    i2c_master_write_byte(cmd, TPS53647_I2CADDR_DEFAULT << 1 | WRITE_BIT, ACK_CHECK);
    i2c_master_write_byte(cmd, command, ACK_CHECK);
    i2c_master_start(cmd);
    i2c_master_write_byte(cmd, TPS53647_I2CADDR_DEFAULT << 1 | READ_BIT, ACK_CHECK);
...
int TPS53647_init(void)
{
    ...
    TPS53647_get_frequency();
    TPS53647_set_frequency(650);
...
void TPS53647_write_entire_config(void)
{
    ...
    smb_write_word(PMBUS_FREQUENCY_SWITCH, int_2_slinear11(TPS53647_INIT_FREQUENCY));

    /* vin voltage */
    ESP_LOGI(TAG, "Setting VIN");
    smb_write_word(PMBUS_VIN_ON, float_2_slinear11(TPS53647_INIT_VIN_ON));
    smb_write_word(PMBUS_VIN_OFF, float_2_slinear11(TPS53647_INIT_VIN_OFF));
    smb_write_word(PMBUS_VIN_UV_WARN_LIMIT, float_2_slinear11(TPS53647_INIT_VIN_UV_WARN_LIMIT));
    smb_write_word(PMBUS_VIN_OV_FAULT_LIMIT, float_2_slinear11(TPS53647_INIT_VIN_OV_FAULT_LIMIT));
    smb_write_byte(PMBUS_VIN_OV_FAULT_RESPONSE, TPS53647_INIT_VIN_OV_FAULT_RESPONSE);

    /* vout voltage */
    ESP_LOGI(TAG, "Setting VOUT SCALE");
    smb_write_word(PMBUS_VOUT_SCALE_LOOP, float_2_slinear11(TPS53647_INIT_SCALE_LOOP));
    ESP_LOGI(TAG, "VOUT_COMMAND");
    smb_write_word(PMBUS_VOUT_COMMAND, float_2_ulinear16(TPS53647_INIT_VOUT_COMMAND));
    ESP_LOGI(TAG, "VOUT_MAX");
    smb_write_word(PMBUS_VOUT_MAX, float_2_ulinear16(TPS53647_INIT_VOUT_MAX));
    ESP_LOGI(TAG, "VOUT_OV_FAULT_LIMIT");
    smb_write_word(PMBUS_VOUT_OV_FAULT_LIMIT, float_2_ulinear16(TPS53647_INIT_VOUT_OV_FAULT_LIMIT));
    ESP_LOGI(TAG, "VOUT_OV_WARN_LIMIT");
    smb_write_word(PMBUS_VOUT_OV_WARN_LIMIT, float_2_ulinear16(TPS53647_INIT_VOUT_OV_WARN_LIMIT));
    ESP_LOGI(TAG, "VOUT_MARGIN_HIGH");
    smb_write_word(PMBUS_VOUT_MARGIN_HIGH, float_2_ulinear16(TPS53647_INIT_VOUT_MARGIN_HIGH));
    ESP_LOGI(TAG, "VOUT_MARGIN_LOW");
    smb_write_word(PMBUS_VOUT_MARGIN_LOW, float_2_ulinear16(TPS53647_INIT_VOUT_MARGIN_LOW));
    ESP_LOGI(TAG, "VOUT_UV_WARN_LIMIT");
    smb_write_word(PMBUS_VOUT_UV_WARN_LIMIT, float_2_ulinear16(TPS53647_INIT_VOUT_UV_WARN_LIMIT));
    ESP_LOGI(TAG, "VOUT_UV_FAULT_LIMIT");
    smb_write_word(PMBUS_VOUT_UV_FAULT_LIMIT, float_2_ulinear16(TPS53647_INIT_VOUT_UV_FAULT_LIMIT));
    ESP_LOGI(TAG, "VOUT_MIN");
    smb_write_word(PMBUS_VOUT_MIN, float_2_ulinear16(TPS53647_INIT_VOUT_MIN));
    ...
    smb_write_word(PMBUS_TON_DELAY, int_2_slinear11(TPS53647_INIT_TON_DELAY));
    ESP_LOGI(TAG, "TON_RISE");
    smb_write_word(PMBUS_TON_RISE, int_2_slinear11(TPS53647_INIT_TON_RISE));
    ESP_LOGI(TAG, "TON_MAX_FAULT_LIMIT");
    smb_write_word(PMBUS_TON_MAX_FAULT_LIMIT, int_2_slinear11(TPS53647_INIT_TON_MAX_FAULT_LIMIT));
    smb_write_byte(PMBUS_TON_MAX_FAULT_RESPONSE, TPS53647_INIT_TON_MAX_FAULT_RESPONSE);
    smb_write_word(PMBUS_TOFF_DELAY, int_2_slinear11(TPS53647_INIT_TOFF_DELAY));
    smb_write_word(PMBUS_TOFF_FALL, int_2_slinear11(TPS53647_INIT_TOFF_FALL));
...
void TPS53647_set_frequency(int newfreq)
{
    uint16_t value;
    int freq;
