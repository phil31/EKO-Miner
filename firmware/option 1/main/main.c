...
void app_main(void)
{
    ...
    if (strcmp(GLOBAL_STATE.device_model_str, "max") == 0) {
        ...
        GLOBAL_STATE.asic_count = 1;
        GLOBAL_STATE.voltage_domain = 1;
    } else if (strcmp(GLOBAL_STATE.device_model_str, "ekominer") == 0) {
        ESP_LOGI(TAG, "DEVICE: EKOminer");
        GLOBAL_STATE.device_model = DEVICE_EKOMB001;
        GLOBAL_STATE.asic_count = 1;
        //GLOBAL_STATE.asic_count = 16;
        GLOBAL_STATE.voltage_domain = 1;
    } else {
